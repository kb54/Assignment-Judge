...
import GUI.UnitFunctionTesterGUI;


public class UnitTestRunner {
	private static String workingDirectory = Tester.workingDirectory;
	...
	public UnitTestRunner(boolean flag) {
		unitTestCaseFileName = UnitFunctionTesterGUI.getUnitTestCaseFileName();
		unitExpectedOutputFileName = UnitFunctionTesterGUI.getUnitExpectedOutputFileName();
		unitProgramOutputFileName = UnitFunctionTesterGUI.getUnitProgramOutputFileName();
	}
