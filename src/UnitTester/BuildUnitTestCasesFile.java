...
public class BuildUnitTestCasesFile {
	...
	private void buildFiles() {
		...
		try {
			unitTestCasesOutputStream = new FileOutputStream(AssignmentJudge.workingDirectory + unitTestCaseFileName, true);
			unitTestCasesExpectedOutputStream = new FileOutputStream(AssignmentJudge.workingDirectory + unitExpectedOutputFileName, true);
